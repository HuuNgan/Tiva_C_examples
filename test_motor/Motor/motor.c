...
void PWM_Config(void)
{
    ...
    PWMGenPeriodSet( PWM1_BASE, PWM_GEN_0, 1999 );     //Total Pulse Period is 20us

    //Set speed to 1. Speed range from 0 to 999.
    //If you set speed to 0, it will work the same as 1000 (max value).
