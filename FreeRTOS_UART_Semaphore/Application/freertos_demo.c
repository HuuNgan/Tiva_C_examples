...
#define ON_GREEN_STR        ("ONGREEN")
#define OFF_GREEN_STR       ("OFFGREEN")
...
int main(void)
{
    ...
    xTaskCreate( vUartTask, "UART sender", 1000, NULL, 2, NULL);
...
void UARTIntHandler(void)
{
    ...
    UARTprintf( "UARTIntHandler - About to give Semaphore\n" );
...
//            UARTCharPutNonBlocking(UART0_BASE, UARTCharGetNonBlocking(UART0_BASE)); //echo character
            UARTgets(receiveString, sizeof(receiveString));
            if(strcmp(receiveString, ON_GREEN_STR) == 0)    commandVal = LED_GREEN_ON;
            else if(strcmp(receiveString, OFF_GREEN_STR) == 0)    commandVal = LED_GREEN_OFF;
        }
